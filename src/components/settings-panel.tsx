...
import { SettingsTemplatesPanel } from "@/components/settings-templates-panel";
      ...
      <Tabs
        ...
        items={[
            ...
            content: (
              <div className="grid gap-6 lg:grid-cols-[440px_1fr]">
                ...
                <section className="panel">
                  ...
                  {loading ? (
                    <p className="py-8 text-sm text-[#69706c]">
                      Loading accounts...
                    </p>
                  ) : null}
                  ...
                  {!loading && !accounts.length ? (
                    <div className="empty-state">
                      ...
                      <div>
                        ...
                        <p>
                          Add your first read-only address to begin tracking.
                        </p>
                      </div>
                    </div>
                  ) : null}
                    ...
                    {accounts.map((account) => (
                      <article className="account-row" key={account.id}>
                        <div className="min-w-0">
                          ...
                          {account.notes ? (
                            <p className="mt-2 text-sm text-[#69706c]">
                              {account.notes}
                            </p>
                          ) : null}
                        </div>
          ...
          },
          {
            id: "templates",
            label: "Templates",
            content: <SettingsTemplatesPanel />,
          },
        ]}
      />
    </main>
